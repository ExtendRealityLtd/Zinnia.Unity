namespace VRTK.Core.Prefabs.Interactions.Controllables
{
    ...
    public abstract class RotationalDrive : Drive<RotationalDriveFacade, RotationalDrive>
    {
        ...
        /// <inheritdoc />
        protected override float CalculateStepValue(RotationalDriveFacade facade)
        {
            float step = Mathf.Lerp(facade.stepRange.minimum, facade.stepRange.maximum, NormalizedValue);
            return Mathf.Round(step / facade.stepIncrement) * facade.stepIncrement;
        }
