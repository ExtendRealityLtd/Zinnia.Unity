...
namespace Test.Zinnia.Cast.Operation.Conversion
{
    ...
    public class ToBoxCastConverterTest
    {
        private GameObject containingObject;
        private PhysicsCast caster;
        private ToBoxCastConverter subject;
        ...
        public void SetUp()
        {
...
#endif
            containingObject = new GameObject("ToBoxCastConverterTest");
            caster = containingObject.AddComponent<PhysicsCast>();
            subject = containingObject.AddComponent<ToBoxCastConverter>();
            ...
            subject.HalfExtentsOverride = Vector3.one * 0.1f;
