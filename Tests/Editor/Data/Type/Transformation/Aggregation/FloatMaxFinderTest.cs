...
namespace Test.Zinnia.Data.Type.Transformation.Aggregation
{
    ...
    public class FloatMaxFinderTest
    {
        private GameObject containingObject;
        private FloatMaxFinder subject;

        [SetUp]
        public void SetUp()
        {
            containingObject = new GameObject("FloatMaxFinderTest");
            subject = containingObject.AddComponent<FloatMaxFinder>();
        }
