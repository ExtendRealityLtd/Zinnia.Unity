...
namespace Test.Zinnia.Data.Type.Transformation.Aggregation
{
    ...
    public class FloatMinFinderTest
    {
        private GameObject containingObject;
        private FloatMinFinder subject;

        [SetUp]
        public void SetUp()
        {
            containingObject = new GameObject("FloatMinFinder");
            subject = containingObject.AddComponent<FloatMinFinder>();
        }
