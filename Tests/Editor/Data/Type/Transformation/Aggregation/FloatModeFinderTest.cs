...
namespace Test.Zinnia.Data.Type.Transformation.Aggregation
{
    ...
    public class FloatModeFinderTest
    {
        private GameObject containingObject;
        private FloatModeFinder subject;

        [SetUp]
        public void SetUp()
        {
            containingObject = new GameObject("FloatModeFinderTest");
            subject = containingObject.AddComponent<FloatModeFinder>();
        }
